...
<head>
    ...
    <script type="text/javascript">
        function checklogin() {
            var ema = document.getElementById("eamil");
            var pass = document.getElementById("password");
            if(ema.value==null || pass.value==null || ema.value=="" || pass.value=="")
                return false;
            else
                return true;
        }
									  ...
									  <div class="login_main_mid">
									    ...
									    <label class="login_content_bold">还不是Estore商场用户？</label>快捷方便的免费注册，让你立刻尽享Estore商场提供的满意服务......
									     ...
									     <div class="login_content_end_bg_end">
									       <input  class="login_register_out" value=" " type="button" onclick="window.location='/toRegistPage'; " />
									      </div>
									    </div>
									  </div>
									  <!-- 登录表单结束 -->                        
